...
import '../GridsH.css'
import team from '../img/Angad.jpg'
import mission from '../img/Meera.jpg'
import vision from '../img/Rakshita.jpg'
import hem from '../img/Hem.jpg'
        ...
        <div className="teamh">
            <div class="row">
                ...
                <div class="col s12 l6 pull-l6 right-align offset-l1" data-aos="fade-up-right">
                    <h2 class="indigo-text text-darken-4">Angad Singh Kataria</h2>
            ...
            <div class="row">
                ...
                <div class="col s12 l6 left-align push-l1 offset-l1" data-aos="fade-up-left">
                    <h2 class="indigo-text text-darken-4">Meera Kapade</h2>
            ...
            <div class="row">
                ...
                <div class="col s12 l6 pull-l6 right-align offset-l1" data-aos="fade-up-right">
                    <h2 class="indigo-text text-darken-4">Rakshita Chawla</h2>
